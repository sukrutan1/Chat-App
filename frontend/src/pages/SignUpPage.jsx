...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      {/* Sağ Panel – Dekoratif */}
      <div className="hidden lg:flex bg-base-200 flex-col items-center justify-center p-12 text-center">
        <div className="max-w-md space-y-6">
          ...
          <h2 className="text-2xl font-bold">Arkadaşlarınla bağlan</h2>
          <p className="text-base-content/60">
            ChatApp ile mesajlaşın, resim paylaşın ve anında iletişim kurun.
          </p>
        </div>
      </div>
    </div>
